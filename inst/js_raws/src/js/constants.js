...
CONSTANTS.KEY_CYCLE_ATLAS             = "KeyL";         // `l` show/hide voxel data
...
CONSTANTS.KEY_CYCLE_ELEC_EDITOR       = "Backquote";    // "`" for cycling through electrodes (localization, experimental)
CONSTANTS.KEY_CYCLE_SURFTYPE_EDITOR   = "Digit4";       // `4` for toggle electrode type (surface ot iEEG, experimental)
CONSTANTS.KEY_NEW_ELECTRODE_EDITOR    = "Digit1";       // `1` new electrode (experimental)
CONSTANTS.KEY_LABEL_FOCUS_EDITOR      = "Digit2";       // `2` for quick edit label (experimental)
