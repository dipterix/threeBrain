...
download_N27 <- function(
  ...
  reset = FALSE, template_dir = getOption('threeBrain.template_dir', '~/rave_data/others/three_brain'), ...
){
  cat2('Downloading N27 brain generated by FreeSurfer', level = 'INFO')
