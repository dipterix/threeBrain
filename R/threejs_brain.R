...
#' @param surface_colormap a color map or its path generated by \code{\link{create_voxel_palette_discrete}} or \code{\link{create_voxel_palette_continuous}} to render surfaces
#' @param voxel_colormap a color map or its path generated by \code{\link{create_voxel_palette_discrete}} or \code{\link{create_voxel_palette_continuous}} to render volume such as atlases
