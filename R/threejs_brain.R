...
#' @param voxel_colormap file path to a color map generated by \code{\link{create_voxel_palette_discrete}} or \code{\link{create_voxel_palette_continuous}} to render volume such as atlases
