...
* `32861939 (HEAD -> master, origin/master, origin/HEAD)` [_`dipterix`_]: Improved lazy rendering so the canvas does not forces the `GPU` to render unless there is a need to
